...
import com.example.androidperformancemanager.account.AccountEventSystem;
import com.example.androidperformancemanager.account.AccountManager;
import com.example.androidperformancemanager.account.AccountSystem;
import com.example.androidperformancemanager.data.ConferenceInfoGateway;
import com.example.androidperformancemanager.event.EventManager;
import com.example.androidperformancemanager.event.EventSystem;
import com.example.androidperformancemanager.message.MessageSearchingSystem;
import com.example.androidperformancemanager.message.MessageSendingSystem;
import com.example.androidperformancemanager.message.MessageUpdatingSystem;
